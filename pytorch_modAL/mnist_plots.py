...
x, run_1_bald, run_2_bald, run_3_bald, run_4_bald, run_5_bald = np.loadtxt('evaluation_same_initial_data/accuracies_bald.txt', usecols=(0, 1, 2, 3, 4, 5), unpack=True)
x, run_1, run_2, run_3, run_4, run_5 = np.loadtxt('evaluation_same_initial_data/accuracies_random.txt', usecols=(0, 1, 2, 3, 4, 5), unpack=True)
x, run_1_entro, run_2_entro, run_3_entro, run_4_entro, run_5_entro = np.loadtxt('evaluation_same_initial_data/accuracies_max_entropy.txt', usecols=(0, 1, 2, 3, 4, 5), unpack=True)
x, run_1_vari, run_2_vari, run_3_vari, run_4_vari, run_5_vari = np.loadtxt('evaluation_same_initial_data/accuracies_max_variation.txt', usecols=(0, 1, 2, 3, 4, 5), unpack=True)
x, run_1_mean_std, run_2_mean_std, run_3_mean_std, run_4_mean_std, run_5_mean_std = np.loadtxt('evaluation_same_initial_data/accuracies_mean_std.txt', usecols=(0, 1, 2, 3, 4, 5), unpack=True)
x = x -250
...
plt.savefig("evaluation_same_initial_data/mnist_evaluation_same_initial_data.pdf" , format='pdf')
plt.legend()
